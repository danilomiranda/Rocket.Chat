RocketChat.models.Tasks = new class extends RocketChat.models._Base {
	constructor() {
		super('task');
		...
		this.tryEnsureIndex({ 'txt': 'text' });
		this.tryEnsureIndex({ 'file._id': 1 }, { sparse: 1 });
		this.tryEnsureIndex({ 'checked': 1 }, { sparse: 1 });
	...
	// INSERT
	createWithTypeRoomIdTextAndUser(type, roomId, text, user, extraData) {
